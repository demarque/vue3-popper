...
var script = {
  ...
  setup(__props, {
    ...
    const openPopperDebounce = debounce_2(open, openDelay.value);
    const closePopperDebounce = debounce_2(close, closeDelay.value);
    ...
    const debouncedIsOpenClear = debounce_2(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        close: unref(closePopperDebounce),
        isOpen: modifiedIsOpen.value
      })], 544), createVNode(Transition, {
        name: "fade"
      }, {
...
script.__scopeId = "data-v-f4651dce";
