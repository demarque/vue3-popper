...
}var debounce$2 = {exports: {}};function debounce$1(function_, wait = 100, options = {}) {
...
var debounce_2 = debounce$2.exports.debounce = debounce$1;

debounce$2.exports = debounce$1;function useEventListener(target, event, handler) {
  if (vue.isRef(target)) {
...
function usePopper(_ref) {
  ...
  var state = vue.reactive({
    isOpen: false,
    effectivePlacement: vue.unref(placement),
    popperInstance: null
  });
...
script$1.__scopeId = "data-v-b6f35172";
var Arrow = script$1;var script = {
  ...
  setup: function setup(__props, _ref) {
    ...
    var _usePopper = usePopper({
      ...
      effectivePlacement = _usePopper.effectivePlacement,
    ...
    var openPopperDebounce = debounce_2(open, openDelay.value);
    var closePopperDebounce = debounce_2(close, closeDelay.value);
    ...
    var debouncedIsOpenClear = debounce_2(function () {
    ...
    return function (_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        close: vue.unref(closePopperDebounce),
        isOpen: modifiedIsOpen.value
      })], 544), vue.createVNode(vue.Transition, {
        name: "fade"
      }, {
...
};script.__scopeId = "data-v-f4651dce";// Default export is installable instance of component.
